...
const JWT_SECRET =
  ...
  "03f166d26bab9394365d354cdba95cea17936b4df707e41a24d1d51769dfee58";
...
const registerUser = async (req, res) => {
  ...
  try {
    ...
    const insertUserQuery =
      'INSERT INTO public."Users" (name, role, email, password, credits, "createdAt") VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP) RETURNING *';
...
const buyCredits = async (req, res) => {
  ...
  try {
    ...
    if (!userId) {
      return res
        .status(401)
        .json({ message: "You must be logged in to buy credits" });
    }
