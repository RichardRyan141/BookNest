...
const community = {
  topReaders: [
    ...
    { name: "David", booksRead: 28, level: "Beginner" },
    { name: "Eve", booksRead: 24, level: "Beginner" },
  ],
};
    ...
    <div className="container mx-auto p-6 max-w-4xl bg-white">
      ...
      <div className="flex gap-4 mb-4 ">
        ...
        <div>
          ...
          <div className="mt-2">
            <p className="text-md font-semibold">Leader: {community.leader}</p>
        ...
        <div className="w-full md:w-1/2 bg-white border border-gray-200 rounded-lg shadow p-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              {/* Reader Count */}
              <p className="text-md text-gray-500">312 people reading this</p>
      ...
      <div className="mb-6 bg-white border border-gray-200 rounded-lg shadow p-3">
        ...
        <p className="text-md  text-sm text-gray-400">
          {community.level < 5 ? "New Community" : "Well-established Community"}
        </p>
      </div>
